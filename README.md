...
| Patient Number | ν<sub>2</sub> | MSE | Exact ECG (orange) vs Numerical ECG (blue) |
:-----------|:---------:|:---------:|:---------:
*Patient 1* | 0.012113108 | 0.020216 | ![nu2_p_1](readme_images/patient_1_noise.png)
*Patient 2* | 0.011852261 | 0.019144 | ![nu2_p_2](readme_images/patient_2_noise.png)
*Patient 3* | 0.011748969 | 0.021651 | ![nu2_p_3](readme_images/patient_3_noise.png) 
